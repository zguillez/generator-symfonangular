...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CommonService A AppBundle\Service\CommonService instance.
     */
    protected function getCommonService()
    {
        return $this->services['common'] = new \AppBundle\Service\CommonService($this->get('session'), $this->get('doctrine.orm.default_entity_manager'), $this->get('swiftmailer.mailer.default'), $this->get('twig'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_89cfbd7f37a6586ff8b92f4555236e9cb1dca8752775f5d722f50c0e6b5442a4');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('740cde1d12c4492e3833cba6f174beccfd0fea6d');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ab31d5708446.17744720')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '740cde1d12c4492e3833cba6f174beccfd0fea6d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '740cde1d12c4492e3833cba6f174beccfd0fea6d',
